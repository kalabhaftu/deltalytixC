...
import { Funnel, TrendUp, ChartBar } from "@phosphor-icons/react"
      ...
      <Card className="max-w-md w-full border-dashed">
        <CardHeader className="text-center pb-4">
          <div className="mx-auto mb-4 w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center">
            <Funnel weight="light" className="h-8 w-8 text-primary" />
          </div>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <div className="flex items-start gap-3 text-sm text-muted-foreground">
              <TrendUp weight="light" className="h-5 w-5 mt-0.5 flex-shrink-0" />
              <p>View performance metrics, charts, and statistics for your trading activity</p>
            </div>
            <div className="flex items-start gap-3 text-sm text-muted-foreground">
              <ChartBar weight="light" className="h-5 w-5 mt-0.5 flex-shrink-0" />
