...
export async function executeGetLastTradesData({ number, startDate, endDate, accountNumber }: { number: number, startDate?: string, endDate?: string, accountNumber?: string }) {
